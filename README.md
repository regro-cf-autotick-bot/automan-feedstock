...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/automan-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7550&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/automan-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `automan` can be installed with:

```
conda install automan
```

It is possible to list all of the versions of `automan` available on your platform with:
